...
- **Multi-architecture support**: for [UXP Hybrid plugins](../../../plugins/concepts/hybrid-plugins/index.md), test on Mac M1, Mac Intel, and Windows Intel
...
| **Multi-architecture failures**: [UXP Hybrid plugins](../../../plugins/concepts/hybrid-plugins/index.md) crash or fail on specific architectures (M1, Intel, Windows).                            | Test on all supported architectures: Mac M1, Mac Intel, and Windows Intel. Build separate binaries for each architecture if needed.                               |
