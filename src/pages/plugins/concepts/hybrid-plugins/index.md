...
Building Hybrid plugins requires proficiency in C++. Make sure you have experience [writing UXP plugins](../../../plugins/index.md) and are comfortable using the [UXP Developer Tool](../../../introduction/essentials/dev-tools/index.md#uxp-developer-tool-udt) before diving in.
...
Before publishing, make sure your plugin includes uxpaddons for **all required platforms and architectures**: macOS x64, macOS arm64, and Windows x64.
...
- The `enableAddon` [permission](../manifest/index.md#requiredpermissions).
...
On macOS, you may need to perform an additional setup step before you can attach a debugger. Follow [Apple's guide to debugging on macOS](https://helpx.adobe.com/ca/photoshop/kb/debug-plugins-in-photoshop-bigsur.html) for details.
...
3. Ensure the plugin works on **all three architectures**: macOS arm64, macOS x64, and Windows x64.
